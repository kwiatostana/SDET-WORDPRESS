...
### **TC\_POS\_001: Создание поста через API с проверкой сохранения в БД**
...
### **TC\_POS\_002: Получение поста по ID и сверка title/status с данными БД**
...
### **TC\_POS\_003: Получение списка постов по include с валидацией указанных ID через БД**
...
### **TC\_POS\_004: Редактирование поста через API с подтверждением обновленных title и content в БД**
...
### **TC\_POS\_005: Удаление поста с force=true и подтверждением очистки записи в БД**
...
### **TC\_NEG\_001: Создание поста с недопустимым статусом и проверкой отсутствия записи в БД**
...
### **TC\_NEG\_002: Запрос несуществующего поста по ID и подтверждение отсутствия записи в БД**
